...
**wget** is free software and available for Linux, Windows, and Mac OS X at [www.gnu.org/software/wget/](https://www.gnu.org/software/wget)

This is an example of how to get files using wget: 

<pre>wget -w 2 -m -H "https://www.gutenberg.org/robot/harvest?filetypes[]=html"</pre>
...
<pre>wget -w 2 -m -H "https://www.gutenberg.org/robot/harvest?filetypes[]=html&langs[]=de"</pre>
