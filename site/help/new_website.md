...
7. Blank pages. One of the back-end web servers has an incomplete or incorrect configuration for PHP. This impacts search results with "search" in the URL (mostly Advanced Search). Just reload the page, and you will eventually get one of the web servers that is working. Status: Working with iBiblio to fix this.
