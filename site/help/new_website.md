...
4. Insufficient line spacing for multi-line book titles on landing pages. When viewing a multi-line (long) book title, such as https://www.gutenberg.org/ebooks/65147 , the first and second lines are too close, thus making the characters overlap. You can also see this by shrinking the window, to make a multi-line display. If you shrink it a lot, the font gets smaller. But the full-size font is aligned too closely. Status: Investigating.
...
3. The "new books" pane at https://www.gutenberg.org has a pop-up tooltip that mentions the title, and we would also like to add the author. Status: Working on it.
...
A new version of [ebookmaker](https://github.com/gutenbergtools/ebookmaker) went into production in late December 2019 and has been updated several times since then. This is what creates our EPUB and MOBI (Kindle) formats. You can run it yourself on the PGLAF upload portal's [ebookmaker test page](https://ebookmaker.pglaf.org).
