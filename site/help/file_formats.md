...
The Moving Pictures Expert Group have released a series of formats for encoding video and audio. MPEG (pronounced EM-peg) formats are published and widely used. The official home page of the MPEG is [www.chiariglione.org/mpeg](https://www.chiariglione.org/mpeg/) but you will find information about MPEG formats, and software to play MPEG files, all over the Net. You can also purchase specifications through [www.iso.ch](https://www.iso.ch).
