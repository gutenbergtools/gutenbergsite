...
class ListMarcFieldsTable extends ListTable
{
    public function __construct()
    {
        ...
        $this->AddColumn(
            "$prefix=delete&amp;fk_marcauthrecs=#fk_marcauthrecs#&amp;fk_marctags=#fk_marctags#\">Unlink</a>",
            "",
            "narrow"
        );
...
class ListAuthorsTable extends ListTable
{
    public function __construct()
    {
        ...
        $this->AddColumn(
            "$prefix=delete&amp;fk_authors=#pk#&amp;fk_roles=#fk_roles#\">Unlink</a>",
            "<a href=\"mn_books_authors_list?fk_books=$fk_books&amp;mode=add\">Link</a>",
            "narrow"
        );
        $this->AddColumn(
            "$prefix=edit&amp;fk_authors=#pk#&amp;fk_roles=#fk_roles#\">Edit&nbsp;Link</a>",
            "",
            "narrow"
        );
...
class ListReviewsTable extends ListTable
{
    public function __construct()
    {
        ...
        $this->AddColumn(
            "$prefix=edit&amp;fk_reviews=#pk#\">Edit</a>",
            "$prefix=add\">Add</a>",
            "narrow"
        );
...
class ListCategoriesTable extends ListTable
{
    public function __construct()
    {
        ...
        $this->AddColumn(
            "$prefix=delete&amp;fk_categories=#pk#\">Unlink</a>",
            "$prefix=add\">Link</a>",
            "narrow"
        );
...
class ListSubjectsTable extends ListTable
{
    public function __construct()
    {
        ...
        $this->AddColumn(
            "$prefix=delete&amp;fk_subjects=#pk#\">Unlink</a>",
            "$prefix=add\">Link</a>",
            "narrow"
        );
...
class ListLangsTable extends ListTable
{
    public function __construct()
    {
        ...
        $this->AddColumn(
            "$prefix=delete&amp;fk_langs=#pk#\">Unlink</a>",
            "$prefix=add\">Link</a>",
            "narrow"
        );
...
class ListLoccsTable extends ListTable
{
    public function __construct()
    {
        ...
        $this->AddColumn(
            "$prefix=delete&amp;fk_loccs=#pk#\">Unlink</a>",
            "$prefix=add\">Link</a>",
            "narrow"
        );
