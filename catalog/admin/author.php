...
class ListAliasesTable extends ListTable
{
    public function __construct()
    {
        ...
        $this->AddColumn(
            "$prefix=edit&fk_aliases=#pk#\">Edit</a>",
            "$prefix=add\">Add</a>",
            "narrow"
        );
        ...
        $this->AddSubCaption("Less prominent names and pseudonyms the author is also known under, " .
...
class ListAuthorUrlsTable extends ListTable
{
    public function __construct()
    {
        ...
        $this->AddColumn(
            "$prefix=edit&fk_author_urls=#pk#\">Edit</a>",
            "$prefix=add\">Add</a>",
            "narrow"
        );
...
class ListBooksTable extends ListTable
{
    ...
    {
        $this->AddColumn(
            "<a href=\"book?mode=edit&fk_books=#fk_books#\">#fk_books#</a>",
            "Etext Nr.",
            "narrow right"
        );
...
if (ismode("delete")) {
    ...
    echo "<br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><h1>editing</h1>\n";
