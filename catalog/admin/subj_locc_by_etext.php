...
class SubjLoccByEtextTable extends MoreTable
{
    ...
    {
        $this->AddColumn(
            "<a href=\"book?mode=edit&fk_books=#pk#\">#pk#</a>",
            "Etext Nr. (edit link)",
            "right"
        );
        $this->AddSimpleColumn("author", "Author");
        $this->AddColumn(
            "<a href=\"/etext/#pk#\">#title#</a>",
            "Title (bibrec link)"
        );
        $this->AddColumn(
            "<span style=\"background-color:#nosubj#;\">" .
                  "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>",
            "No Subj",
            "narrow"
        );
        $this->AddColumn(
            "<span style=\"background-color:#nolocc#;\">" .
                  "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>",
            "No LoCC",
            "narrow"
        );
...
$db->Exec($sql);
// gbn: 20091213
echo "<p align=\"center\"><a href=\"http://www.gutenberg.org/catalog/admin/subj_locc_by_etext.php?within_the_last=1\">Last day only</a></p>\n";
