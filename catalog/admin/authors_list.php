...
class ListAuthorsTable extends ListTable
{
    public function __construct()
    {
        ...
        $this->AddColumn(
            "<a href=\"author?mode=edit&fk_authors=#pk#\">Edit</a>",
            "<a href=\"author?mode=add\">Add</a>",
            "narrow"
        );
        $this->AddColumn(
            "<a href=\"author?mode=delete&fk_authors=#pk#\">Delete</a>",
            "",
            "narrow"
        );
        if ($fk_authors_from) {
            $this->AddColumn(
                "<a href=\"authors_transfer?author_from=$author_from&amp;author_to=#author#&amp;" .
            ...
            $this->AddColumn(
                "<a href=\"authors_list?author_from=#author#&amp;" .
